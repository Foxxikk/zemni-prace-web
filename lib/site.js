...
export const sluzby = [
  { slug: "vykopy-zakladu", title: "Výkopy základů", desc: "Vytyčení stavby, skrývka ornice a hloubeni základových pasů pro rodinné domy i menší stavby." },
  ...
  { slug: "bazeny-jezirka", title: "Bazény a jezírka", desc: "Hloubeni jam pro bazény a zahradní jezírka různých rozměrů a tvarů." },
  ...
  { slug: "ploty-drenaze", title: "Základy plotů a drenáže", desc: "Hloubeni základů pro ploty, výkopy drenáží a svodů." },
  { slug: "jamy-stromy", title: "Jámy pro stromy", desc: "Hloubeni jam pro výsadbu stromů a další zahradní výkopové práce." },
];

// Kompletní výčet prací.
export const seznamPraci = [
  "výkopy základů",
  "hloubeni bazénů",
  "hloubeni zahradních jezírek",
  "hloubeni základů pro ploty",
  "výkopy přípojek inženýrských sítí",
  "hloubeni jam pro stromy",
  "výkopy drenáží",
  "výkopy svodů",
  "úpravy terénů",
  "zajištění pažení",
...
export const technika = [
  ...
  { name: "CAT T320", type: "Pásové rypadlo", use: "Větší výkopy, hloubeni základů a jam, práce na nezpevněném terénu.", img: "/technika/cat-t320.webp" },
  ...
  { name: "Wacker Neuson RTSC3", type: "Vibrační hutnící válec – dálkově řízený", use: "Hutnění zásypů rýh, podkladních vrstev pod dlažbu a příjezdové cesty i práce ve výkopech.", img: "/technika/vibracni-valec.jpg" },
  { name: "Nákladní vůz – nosič kontejnerů", type: "Kontejnerový nosič se sklápěcí korbou", use: "Přistavení kontejneru, odvoz zeminy, suti a stavebního odpadu, dovoz štěrku, písku a kameniva.", img: "/technika/nosic-kontejneru.jpg" },
  { name: "Tatra", type: "Třístranný sklápěč", use: "Odvoz větších objemů zeminy a dovoz materiálu i do hůře přístupného a nezpevněného terénu.", img: "/technika/tatra.jpg" },
];
