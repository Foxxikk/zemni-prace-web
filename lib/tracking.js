...
export const ADS_ID = process.env.NEXT_PUBLIC_GADS_ID || "AW-18396990280";

export const LABELS = {
  form: process.env.NEXT_PUBLIC_GADS_LABEL_FORM || "Jx0NCNDs8-QcEMiWr8RE",
  tel: process.env.NEXT_PUBLIC_GADS_LABEL_TEL || "M6fdCNPs8-QcEMiWr8RE",
