...
export const lokality = [
    ...
    faq: [
      {
        ...
        a: "Ano, svahování a modelace terénu jsou tady naše nejčastější práce. Přebytečnou zeminu buď rozprostřeme na pozemku, nebo ji odvezeme v kontejneru.",
      },
      {
    ...
    faq: [
      {
        ...
        a: "Snažíme se o to. Kolem kořenového systému pracujeme s minirypadlem a poslední část dokopáváme ručně, aby se silné kořeny nepřerušily.",
      },
      {
  ...
  },
  {
    ...
    podlozi:
      "Podloží je písčito-hlinité s vrstvami kamení, na okrajích lesa hodně prorostlé kořeny. Výkopy je proto potřeba vést s rozmyslem.",
    typicke: [
